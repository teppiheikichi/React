        ...
        return (
            <div>
                <div className="card bg-light" style={{ width: 300 }}>
                    <img className="card-img-top" src="./img/sp_iphoneX.png" alt="Card_item" style={{ maxWidth: '100%', height: 250 }} />
                    <div className="card-body text-center">
                        ...
                        <a href="_#" className="btn btn-primary">Detail</a>
                        <a href="_#" className="btn btn-danger">Cart</a>
                    </div>
                </div>
            </div>
        )
